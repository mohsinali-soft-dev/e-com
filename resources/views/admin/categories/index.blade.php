...
<form class="card search-row" method="GET" action="{{ route('admin.categories.index') }}" data-live-search style="margin-bottom:16px;">
    <input type="search" name="search" value="{{ request('search') }}" placeholder="Search categories or parent category" autocomplete="off">
