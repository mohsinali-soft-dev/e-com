...
<div class="card" style="margin-top:16px;">
    <div class="table-wrap">
        <table>
            ...
            <tbody id="cartBody">
            <tr><td colspan="6">No items scanned yet.</td></tr>
            </tbody>
        </table>
    </div>
</div>
    ...
    async function scanBarcode(barcode) {
        ...
        try {
            ...
            if (!response.ok || !data.success) {
                posMessage.textContent = data.message || 'Product not found.';
                return;
            }
            ...
            posMessage.textContent = 'Scan failed. Please try again.';
        }
    }
        ...
        cart.forEach(item => {
            ...
            cartBody.innerHTML += `
                <tr>
                    ...
                    <td><input type="number" min="0.001" step="0.001" value="${item.qty}" onchange="updateQty(${item.id}, this.value)" style="width:110px;"></td>
